        ...
        if (name === "로그아웃") {
          ...
          return (
            ...
            >
              <Link to={to}>
                {icon}
                <span className="absolute top-0 inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-red-500 border-[3px] border-white rounded-full -right-3">
                  {cart?.length}
                </span>
              </Link>
            </li>
